...
public final class BlueprintSurfaceRules extends SurfaceRules {
	public static final DeferredRegister<MapCodec<? extends RuleSource>> RULE_SOURCES = DeferredRegister.create(Registries.MATERIAL_RULE, Blueprint.MOD_ID);

	public static final DeferredHolder<MapCodec<? extends RuleSource>, MapCodec<? extends RuleSource>> TRANSIENT_MERGED = RULE_SOURCES.register("transient_merged", TransientMergedRuleSource.CODEC::codec);
